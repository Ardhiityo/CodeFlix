            ...
            <ul class="pt-3 nav-icon d-flex">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu user-info">
                        <li>
                            {{-- <a class="dropdown-item user-info-item" href="{{ route('profile.overview') }}"><i
                                    class="fa-solid fa-circle-user"></i> Profile Setting</a> --}}
                            <a class="dropdown-item user-info-item" href=""><i
                                    class="fa-solid fa-circle-user"></i> Profile Setting</a>
                        </li>
                        <li>
